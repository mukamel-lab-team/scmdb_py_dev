...
from plotly.graph_objs import Layout, Box, Scatter, Scatter3d, Scattergl
...
def get_3D_cluster_points(species):
    ...
    if not species_exists(species):
        return None
    try:
        with open('{}/{}/3D_tsne_points.tsv' .format(current_app.config['DATA_DIR'],
                                                     species)) as fp:
            return list(
...
def get_cluster_plot(species, grouping="cluster_ordered"):
    ...
    if not points_2D or not points_3D:  # possibly change
    ...
    #     trace_2D = traces.setdefault(cluster_sample_num,
    #       Scattergl(
    #           x=list(),
    #           y=list(),
    #           text=list(),
    ...
    #                 },
    #           hoverinfo='text'))
    #     trace_2D['x'].append(point['tsne_x'])
    #     trace_2D['y'].append(point['tsne_y'])
    #     trace_2D['text'].append(
    #         build_hover_text({
    ...
    for point in points_3D:
        trace_3D['x'].append(point['tsne_1'])
        trace_3D['y'].append(point['tsne_2'])
        trace_3D['z'].append(point['tsne_3'])
        trace_3D['text'].append(point['cells'])
