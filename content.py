...
from plotly.graph_objs import Layout, Box, Scatter, Scattergl, Scatter3d
...
#TODO: fix ortholog plot.
# Currently doesn't work because no 'mmu' or 'hsa' directories to look up mch
@cache.memoize(timeout=3600)
